...
- **Timestamps:** Project0 mandates strict RFC 3339 UTC strings (`TIMESTAMP_REGEX`) for fields like `createdAt`. Resolution: `validateTimestamp` is fully implemented and mapped within the test pipeline.
